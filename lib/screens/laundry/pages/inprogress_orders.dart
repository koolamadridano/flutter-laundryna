...
class LaundryInProgressOrders extends StatefulWidget {
  const LaundryInProgressOrders({Key? key}) : super(key: key);

  @override
  State<LaundryInProgressOrders> createState() =>
      _LaundryInProgressOrdersState();
}

class _LaundryInProgressOrdersState extends State<LaundryInProgressOrders> {
  final _profile = Get.put(ProfileController());
  final _order = Get.put(OrderController());

  late Future<dynamic> _orders;

  void onNavigateToPreviewInprogressOrders(data) {
    //  _laundry.selectedLaundry = data;
    _order.selectedOrder = data;
    Get.toNamed("/preview-customer-order-inprogress");
  }
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  onTap: () => onNavigateToPreviewInprogressOrders(
                    snapshot.data[index],
                  ),
                        ...
                        ExpandableTheme(
                          ...
                          child: ExpandablePanel(
                            ...
                            collapsed: Column(
                              ...
                              children: [
                                Text(
                                  "Status Updated ${Jiffy(_dateUpdate).startOf(Units.SECOND).fromNow()}",
                                  style: GoogleFonts.roboto(
                                    color: kCharcoal.withOpacity(0.5),
                                    fontWeight: FontWeight.w400,
                                    fontSize: 12.0,
