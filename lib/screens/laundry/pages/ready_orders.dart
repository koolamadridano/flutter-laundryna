...
class LaundryReadyOrders extends StatefulWidget {
  const LaundryReadyOrders({Key? key}) : super(key: key);

  @override
  State<LaundryReadyOrders> createState() => _LaundryReadyOrdersState();
}

class _LaundryReadyOrdersState extends State<LaundryReadyOrders> {
  ...
  void onNavigateToPreviewReadyOrders(data) {
    ...
    Get.toNamed("/preview-customer-order-ready");
  }
