...
class PreviewCustomerInprogressOder extends StatefulWidget {
  const PreviewCustomerInprogressOder({Key? key}) : super(key: key);

  @override
  State<PreviewCustomerInprogressOder> createState() =>
      _PreviewCustomerInprogressOderState();
}

class _PreviewCustomerInprogressOderState
    extends State<PreviewCustomerInprogressOder> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () => Get.toNamed("/laundry-orders"),
            splashRadius: 20.0,
            icon: const Icon(
              AntDesign.arrowleft,
              color: Colors.white,
