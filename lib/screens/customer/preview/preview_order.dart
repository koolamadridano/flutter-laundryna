            ...
            JustTheTooltip(
              ...
              child: IconButton(
                onPressed: () => onCallNumber(
                  _order.selectedOrder["header"]["laundry"]["contactNo"],
                ),
                splashRadius: 20,
                icon: const Icon(
                  ...
                  Expanded(
                    child: CircleAvatar(
                      ...
                      backgroundImage: NetworkImage(
                        _order.selectedOrder["header"]["laundry"]["banner"],
                      ),
                      radius: 30.0,
                    ),
                  ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  _order.selectedOrder["header"]["laundry"]
                                      ["name"],
                                  style: GoogleFonts.roboto(
                                    color: kCharcoal,
                                    fontSize: 14.0,
