...
class CustomerDeliveredOrders extends StatefulWidget {
  const CustomerDeliveredOrders({Key? key}) : super(key: key);

  @override
  State<CustomerDeliveredOrders> createState() =>
      _CustomerDeliveredOrdersState();
}

class _CustomerDeliveredOrdersState extends State<CustomerDeliveredOrders> {
                        ...
                        ExpandableTheme(
                          ...
                          child: ExpandablePanel(
                            ...
                            collapsed: Column(
                              ...
                              children: [
                                Text(
                                  "Delivered ${Jiffy(_dateUpdate).startOf(Units.SECOND).fromNow()}",
                                  style: GoogleFonts.roboto(
                                    color: kCharcoal.withOpacity(0.5),
                                    fontWeight: FontWeight.w400,
                                    fontSize: 12.0,
