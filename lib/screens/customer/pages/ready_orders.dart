...
class CustomerReadyOrders extends StatefulWidget {
  const CustomerReadyOrders({Key? key}) : super(key: key);

  @override
  State<CustomerReadyOrders> createState() => _CustomerReadyOrdersState();
}

class _CustomerReadyOrdersState extends State<CustomerReadyOrders> {
