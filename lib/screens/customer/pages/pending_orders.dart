...
class CustomerPendingOrders extends StatefulWidget {
  ...
  @override
  State<CustomerPendingOrders> createState() => _CustomerPendingOrdersState();
}
...
class _CustomerPendingOrdersState extends State<CustomerPendingOrders> {
  ...
  Future<void> onCancelOrder(id) async {
    Get.bottomSheet(
      Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextButton(
                            onPressed: () =>
                                onCancelOrder(snapshot.data[index]["_id"]),
                            child: Text(
                              "CANCEL",
                              style: GoogleFonts.roboto(
                                color: Colors.red,
