...
class CustomerInprogressOrders extends StatefulWidget {
  const CustomerInprogressOrders({Key? key}) : super(key: key);

  @override
  State<CustomerInprogressOrders> createState() =>
      _CustomerInprogressOrdersState();
}

class _CustomerInprogressOrdersState extends State<CustomerInprogressOrders> {
